...
public class ValidaAWS implements ValidaInscricaoCurso {
     ...
     *
     * @param aluno
     * @param nomeCurso tem que existir dentro das inscrições existentes do aluno.
     *                  Este curso tem que estar antes do início do curso cadastrado.
     * @return
     */
    @Override
    public boolean isValid(Aluno aluno, String nomeCurso) {
        ...
        return null!=inscricaoCurso && inscricaoCurso.getDataInicioCurso().isBefore(LocalDate.now());
    }
